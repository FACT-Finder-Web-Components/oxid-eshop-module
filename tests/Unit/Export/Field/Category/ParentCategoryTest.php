...
class ParentCategoryTest extends TestCase
{
    ...
    {
        // When & Then
        $this->assertEquals('ParentCategory', (new ParentCategory())->getName());
    }
    ...
    public function testShouldReturnValueForTopCategory()
    {
        ...
        // When
        $value = (new ParentCategory())->getValue($category, $category);
    ...
    public function testShouldReturnValueForSecondLevelCategory()
    {
        ...
        // When
        $value = (new ParentCategory())->getValue($category2, $category);
    ...
    public function testShouldReturnValueForFourthLevelCategory()
    {
        ...
        // When
        $value = (new ParentCategory())->getValue($category4, $category3);

        // Then
        $this->assertEquals("Gear/Fashion/For Him", $value);
    }
}
