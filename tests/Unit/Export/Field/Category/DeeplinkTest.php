...
class DeeplinkTest extends TestCase
{
    ...
    {
        // When & Then
        $this->assertEquals('Deeplink', (new Deeplink())->getName());
    }
    ...
    public function testShouldReturnValueForTopCategory()
    {
        ...
        // When
        $value = (new Deeplink())->getValue($category, $category);
    ...
    public function testShouldReturnValueForSecondLevelCategory()
    {
        ...
        // When
        $value = (new Deeplink())->getValue($category2, $category);
    ...
    public function testShouldReturnValueForFourthLevelCategory()
    {
        ...
        // When
        $value = (new Deeplink())->getValue($category4, $category3);

        // Then
        $this->assertEquals("/Gear/Fashion/For-Him/Shirts-Co/", $value);
    }
}
