...
This is a migration guide which should help you update your Oxid module to the WebComponents from v4 to v5 if for some reason you do not want to use our ready-made module.
