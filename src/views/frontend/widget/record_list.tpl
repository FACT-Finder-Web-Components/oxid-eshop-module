    ...
    <ff-record class="productData col-xs-12 col-sm-6 col-md-4 productBox">
        <form action="[{$oViewConf->getSelfActionLink()|escape}]" method="post">
            ...
            <div class="listDetails text-center">
                <div class="title">
                    <a data-redirect="{{record.Deeplink}}" data-redirect-target="_blank" data-anchor="{{record.Deeplink}}" title="{{record.Name}}">
                ...
                <div class="actions text-center">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-primary" data-redirect="{{record.Deeplink}}" data-redirect-target="_blank" data-anchor="{{record.Deeplink}}">[{oxmultilang ident="MORE_INFO"}]</a>
                    </div>
                </div>
            </div>
        </form>
