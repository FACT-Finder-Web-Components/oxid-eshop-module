...
$aLang = [
    ...
    'HELP_SHOP_MODULE_ffExportAttributes'         => 'Select attributes which you want to export. Multi-Attribute set to `No` means that specific attribute will be exported in separate column. Setting `Numerical` means that given attribute will be exported in aggregate column `NumericalAttributes`',
