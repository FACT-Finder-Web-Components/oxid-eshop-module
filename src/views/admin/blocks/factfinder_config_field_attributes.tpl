[{if $module_var === 'ffExportAttributes'}]
    [{oxscript include=$oViewConf->getModuleUrl('ffwebcomponents','out/admin/js/custom-elements-es5-adapter.js') priority=1}]
    [{oxscript include=$oViewConf->getModuleUrl('ffwebcomponents','out/admin/js//webcomponents-loader.js') priority=2}]
